...
AuthService.ɵfac = function AuthService_Factory(t) { return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_userdata_service__WEBPACK_IMPORTED_MODULE_2__["UserdataService"])); };
...
CartListComponent.ɵfac = function CartListComponent_Factory(t) { return new (t || CartListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_cartdata_service__WEBPACK_IMPORTED_MODULE_1__["CartdataService"])); };
CartListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CartListComponent, selectors: [["app-cart-list"]], decls: 4, vars: 1, consts: [[4, "ngFor", "ngForOf"], [3, "src"]], template: function CartListComponent_Template(rf, ctx) { if (rf & 1) {
...
CartdataService.ɵfac = function CartdataService_Factory(t) { return new (t || CartdataService)(); };
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 14, vars: 3, consts: [["matInput", "", "type", "text", "name", "username", "required", "", 3, "ngModel", "ngModelChange"], ["type", "password", 3, "ngModel", "ngModelChange"], [3, "click"], ["routerLink", "/registration", 1, "btn", "btn-link"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "button", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_8_listener() { return ctx.onSubmit(); });
...
MenuComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MenuComponent, selectors: [["app-menu"]], decls: 10, vars: 0, consts: [[1, "nav", "nav-pills"], ["role", "presentation"], ["routerLink", "products"], ["routerLink", "users"], ["routerLink", "cart"]], template: function MenuComponent_Template(rf, ctx) { if (rf & 1) {
...
PriceupdaterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PriceupdaterComponent, selectors: [["app-priceupdater"]], inputs: { pricevalue: "pricevalue" }, outputs: { update: "update" }, decls: 3, vars: 1, consts: [["type", "number", 3, "ngModel", "ngModelChange"], [3, "click"]], template: function PriceupdaterComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](RoutingModule, { imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]] }); })();
...
UserdetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserdetailsComponent, selectors: [["app-userdetails"]], decls: 9, vars: 3, template: function UserdetailsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
UserlistComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UserlistComponent, selectors: [["app-userlist"]], decls: 5, vars: 1, consts: [[4, "ngFor", "ngForOf"], [3, "routerLink"]], template: function UserlistComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h2");
